(function (win, und) {
	...
	const
		aliases = {
			...
			'数值积分' : ['SIMPSON积分', '辛普森积分', 'ROMBERG算法', '龙贝格算法'],
			...
			'前缀和优化' : ['前缀和', '部分和优化', '部分和'],
			'LCT' : ['LCT', 'LINK-CUT TREE', 'LINK CUT TREE'],
			'动态规划' : ['DP', '动规'],
			'区间 DP' : ['区间动态规划', '区间动规'],
			'单位根' : ['单位根反演'],
			'双指针' : ['尺取法', '双指针法'],
			...
			'万能 Euclid 算法' : ['万能欧几里得算法'],
			'线性筛' : ['线性筛法', '线筛', 'EULER筛', 'EULER筛法', '欧拉筛', '欧拉筛法'],
			'线性齐次递推式' : ['线性递推', '线性递推式', '线性齐次递推'],
			'线段树' : ['SEGMENT TREE'],
			'Segment Tree Beats!' : ['线段树 BEATS', 'STB', 'ST BEATS', '击败型线段树', '吉氏线段树', '吉司机线段树', '吉老师线段树'],
